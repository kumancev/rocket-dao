...
import RocketDAO from './abis/RocketDAO.json'
...
const loadWeb3 = async () => {
  try {
    ...
    const networkData = RocketDAO.networks[networkId]
    ...
    if (networkData) {
      ...
      window.alert('RocketDAO contract not deployed to detected network.')
    }
    return true
  } catch (error) {

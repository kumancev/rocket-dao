...
import { raiseProposal } from '../Rocket'
    ...
    >
      <div className="bg-white dark:bg-[#212936] shadow-xl shadow-[#122643] dark:shadow-gray-500 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <form className="flex flex-col">
          ...
          <button
            className="rounded-lg px-6 py-2.5 bg-rose-600
              text-white font-medium text-xs leading-tight
              uppercase hover:bg-rose-700 focus:bg-rose-700
              focus:outline-none focus:ring-0 active:bg-rose-800
